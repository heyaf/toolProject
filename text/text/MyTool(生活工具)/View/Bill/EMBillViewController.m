...
- (void)initUI
{
//    UILabel *titleLabel = [[UILabel alloc] initWithFrame:CGRectMake(0, 0, kScreenW, kNavBarHeight)];
...
//        [_publishButton setImage:[UIImage imageNamed:@"add3"]
//                        forState:UIControlStateNormal];
//        [_publishButton setImageEdgeInsets:UIEdgeInsetsMake(5, 0, 5, 5)];
        UIImageView *imagev = [[UIImageView alloc] initWithFrame:CGRectMake(0, 0, 50, 50)];
        imagev.image = [UIImage imageNamed:@"add4"];
        [_publishButton addSubview:imagev];
        
        [imagev mas_makeConstraints:^(MASConstraintMaker *make) {
            make.top.mas_equalTo(self->_publishButton).offset(5);
            make.right.mas_equalTo(self->_publishButton).offset(-5);
