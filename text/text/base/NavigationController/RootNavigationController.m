...
+ (void)initialize
{
    ...
    //导航栏背景图
    UIView *view = [[UIView alloc] initWithFrame:CGRectMake(0, 0, kScreenW, kNavBarHeight)];
    view.backgroundColor = kMainColor;
    [navBar setBackgroundImage:[self snapshotSingleView:view] forBarMetrics:UIBarMetricsDefault];
    [navBar setBarTintColor:kClearColor];
    [navBar setTintColor:kWhiteColor];
    [navBar setTitleTextAttributes:@{NSForegroundColorAttributeName :kWhiteColor, NSFontAttributeName : [UIFont systemFontOfSize:17]}];
