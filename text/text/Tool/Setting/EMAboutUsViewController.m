...
- (UILabel *)appInfoLabel
{
    if (!_appInfoLabel) {
        ...
        NSString *appInfo = [NSString stringWithFormat:@"Version %@ (%@)", [EMDeviceUtil sharedDevice].appVersion, [EMDeviceUtil sharedDevice].appBuildVersion];
...
- (UILabel *)introduceLabel
{
    if (!_introduceLabel) {
        ...
        _introduceLabel.text = NSLocalizedString(@"让记账更简单一点", nil);
