...
#import "MCStack.h"
@implementation MCCalculatorObject
...
+ (NSArray *)expresConversion:(NSArray *)array {
    ...
    MCStack<NSString *> *stack = MCStack.stack; //操作符的容器
...
+ (BOOL)bracketsMatch:(NSArray *)array {
    ...
    MCStack<NSString *> *stack = MCStack.stack;
